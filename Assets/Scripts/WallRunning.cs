...
public class WallRunning : MonoBehaviour
{
    ...
    private void WallRunningMovement()
    {
        ...
        if (upwardsRunning)
        {
            rb.velocity = new UnityEngine.Vector3(rb.velocity.x, wallClimbSpeed, rb.velocity.z);
        }
        if (downwardsRunning)
        {
            rb.velocity = new UnityEngine.Vector3(rb.velocity.x, -wallClimbSpeed, rb.velocity.z);
    ...
    private void WallJump()
    {
        ...
        UnityEngine.Vector3 forceToApply = transform.up * wallJumpUpForce + wallNormal * wallJumpSideForce;
